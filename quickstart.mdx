---
title: "Quickstart"
description: "Get started with RegPilot in 5 minutes. Create your account, generate API keys, and make your first compliant AI request with our step-by-step guide."
seo:
  title: "RegPilot Quickstart - Get Started in 5 Minutes"
  description: "Quick setup guide for RegPilot EU AI Act compliance platform. Learn how to create an account, generate API keys, and integrate AI compliance validation into your application."
  keywords: "RegPilot quickstart, AI compliance setup, API key generation, EU AI Act integration, get started with RegPilot"
---
